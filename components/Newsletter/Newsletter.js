    ...
    return (
        <div className="flex flex-col container justify-between max-w-4xl mx-auto mb-4">
            ...
            <form
                ...
                <input type="hidden" value="1" name="embed" /><input type="submit" className="text-sm bg-indigo-100 hover:bg-indigo-700 focus:bg-indigo-700 hover:text-white focus:text-white transition duration-200 rounded-full py-2 px-4 absolute right-[1.5%] md:right-[2.5%] cursor-pointer top-[26%]" value="Subscribe" />
            </form>
        </div>
    )
}
