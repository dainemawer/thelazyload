                    ...
                    {`
                        {
                            ...
                            "@graph":[
                                    ...
                                    "potentialAction": [
                                        {
                                            ...
                                            "query-input": {
                                                "@type":"PropertyValueSpecification",       "valueName":"search_term_string",
                                                "valueRequired": true
                                            }
                                        }
                                    ],
                                ...
                                },
                                {
                                    ...
                                    "@id":"${url}/#webpage",
                                    "url":"${url}",
                                    "name": "The Lazy Load is a web performance blog that attempts to shed light and provide insight on everyday performance issues.",
                                    "isPartOf": {
                                        "@id":"${url}/#website"
                                    },
                                    "about":{
